...
*/
  ...
  #define PID_FUEL_TRIM_B2_S1               "01 18" // (B-128) * 100/128 (if B==$FF, sensor is not used in trim calc)
  #define PID_FUEL_TRIM_B2_S2               "01 19" // (B-128) * 100/128 (if B==$FF, sensor is not used in trim calc)
  #define PID_FUEL_TRIM_B2_S3               "01 1A" // (B-128) * 100/128 (if B==$FF, sensor is not used in trim calc)
  #define PID_FUEL_TRIM_B2_S4               "01 1B" // (B-128) * 100/128 (if B==$FF, sensor is not used in trim calc)
  // End Special Case.
  ...
  #define PID_EVAP_SYSTEM_VAPOR_PRESSURE_1  "01 32" // ((A*256)+B)/4 (A and B are two's complementsigned)
  ...
  #define PID_EVAP_SYSTEM_VAPOR_PRESSURE_2                             "01 54" // ((A*256)+B)-32767
  ...
  #define PID_TURBOCHARGER_TEMP_1                                      "01 75" //
  #define PID_TURBOCHARGER_TEMP_2                                      "01 76" //
  ...
  #define PID_DIESEL_PARTICULATE_FILTER_1                              "01 7A" //
  #define PID_DIESEL_PARTICULATE_FILTER_2                              "01 7B" //
  ...
  #define PID_ENGINE_RUN_TIME_FOR_AUXILIARY_EMISSIONS_CONTROL_DEVICE_1 "01 81" //
  #define PID_ENGINE_RUN_TIME_FOR_AUXILIARY_EMISSIONS_CONTROL_DEVICE_2 "01 82" //
